import DR20API
#We can use all the functions in the DR20API library
import numpy as np
#numpy is a library for computing
import matplotlib.pyplot as plt
#This library is to draw the graph
import time
...
if __name__ == '__main__':
    ...
    # r is for red and '-' is for straght line
    #plt.plot is going to draw some points
    ...
    plt.axis("equal")
    plt.show()
    #plt.show is going to draw the graph for me
    # Move the robot along the test path.
    #I have to close it if I want to go on
